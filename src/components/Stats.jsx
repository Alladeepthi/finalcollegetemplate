        ...
        <div className="stats-container">
            ...
            <div className="stat-item">
                <div className="stat-icon pink">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="40" height="40">
                        ...
                        <path d="M10.5 5.25a.75.75 0 00-1.5 0v3.5h-3.5a.75.75 0 000 1.5h3.5v3.5a.75.75 0 001.5 0v-3.5h3.5a.75.75 0 000-1.5h-3.5v-3.5z" />
            ...
            <div className="stat-item">
                <div className="stat-icon blue">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="40" height="40">
                        <path fillRule="evenodd" d="M15.5 12.75a3.75 3.75 0 00-3.75-3.75h-7.5a3.75 3.75 0 00-3.75 3.75v3a3.75 3.75 0 003.75 3.75h.75a3.75 3.75 0 003.75 3.75h3.75a3.75 3.75 0 003.75-3.75v-.75a3.75 3.75 0 003.75-3.75v-3zm0 3v-3h1.5v3h-1.5z" clipRule="evenodd" />
